  ...
  // NOTE:***********************************************END*************************************************************
    ...
    public function checkStepsList()
    {
        ...
        try {
            ...
            $txt .= "<textarea id='demoQuery' name='demoQuery' class='form-control' rows='6' cols='120'>SELECT MD_CODE, MD_NAME, SUM(TOTAL_AMOUNT) FROM salesdata_senior_by_product</textarea>";
            ...
            $txt .= '<input max="12" type="number" id="data-monthnum" class="form-control" name="source-name" value="" required="required" placeholder="2018 MONTH NUMBER">';

            // $txt .= "</div'>";
            // $txt .= "<div class='col-md-4'>";
            $txt .= "<a href='#' id='data-displayvalue' class='btn btn-info btn btn-xs' style='margin-top:3px; float:right;'><i class='fas fa-poll-h'></i> DISPLAY VALUE</a>";
            // $txt .= "<a href='#' id='data-save' class='btn btn-info btn btn-xs' style='margin-top:3px; float:right;'><i class='fas fa-poll-h'></i>SAVE</a>";
            $txt .= "</div'>";
