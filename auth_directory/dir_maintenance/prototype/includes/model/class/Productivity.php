  ...
  global $conn_pdo;
      try {
        ...
        if ($md_code) {
              ...
              if ($month) $date_sql = "AND crediting_date = '$date' ";
              else $date_sql = "";
              ...
              if (strpos($sql, "WHERE") !== FALSE) {
                  ...
                  if (strpos($sql_exploded[1], "GROUP BY") !== FALSE ) {
                    ...
                    $sql = $sql_exploded[0] . " WHERE " . $sql_exploded2[0] . " AND crediting_date = '$date'
                    GROUP BY " . $sql_exploded2[1];

                  } else {

                    $sql = $sql_exploded[0] . " WHERE " . $sql_exploded[1] . " AND crediting_date = '$date' ";
                  }
                  ...
                  if (strpos($sql, "GROUP BY") !== FALSE) {
                      ...
                      $sql_explode = explode("GROUP BY", $sql);
                      $sql = $sql_explode[0] . " WHERE 1=1 AND crediting_date = '$date' GROUP BY " . $sql_explode[1];
